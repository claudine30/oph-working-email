            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php endif; ?>
                        <?php if(isset($_SESSION['userdata']['id']) && ($_settings->userdata('type') == 1)): ?>

                        <li class="nav-item"><a class="nav-link" href="./?page=admin_page">For Admin</a></li>
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link" href="./?page=about_us">About Us</a></li>
                    </ul>
                    <div class="navbar-nav ml-auto d-flex align-items-center">
                      <?php if(isset($_SESSION['userdata']['id']) && $_settings->userdata('type') == 2 || ($_settings->userdata('type') == 1)): ?>
