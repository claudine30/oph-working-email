...
<div class='container py-5'>
    <div class='card card-ouline-primary'>
        <div class='card-header'>
            <h5 class='card-title'>Update Student Information/Credentials</h5>
        </div>
        <div class='card-body'>
                ...
                <div class='row'>
                    <div class='col-md-6'>
                        <div class='form-group'>
                                ...
                                <input type='text' autofocus class='form-control form-control-border' id='studID' name='studID' value='<?php echo isset($studID) ? $studID : '' ?>' required>
                            </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                            <label for='gender' class='control-labelo'>Gender</label>
                        ...
                        <div class='form-group'>
                            ...
                            <input type='date' class='form-control form-control-border' id='dob' name='dob' value='<?php echo isset($dob) ? $dob: '' ?>' required>
                        </div>
                        <div class='form-group'>
                            <label for='contact' class='control-label'>Contact #</label>
                            <input type='text' class='form-control form-control-border' id='contact' name='contact' value='<?php echo isset($contact) ? $contact : '' ?>' required>
                        </div>
                    </div>
                    ...
                    <div class='col-md-6'>
                        ...
                        <div class='form-group'>
                            <label for='address' class='control-label'>Course</label>
                            <textarea rows='1' class='form-control form-control-border' id='course' name='course' required><?php echo isset($course) ? $course : '' ?></textarea>
                        </div>
                        <div class='form-group'>
