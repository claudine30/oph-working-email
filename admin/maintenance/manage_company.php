...
<div class="container-fluid">
	<form action="" id="company-form">
		...
		<div class="form-group col-6">
			<label for="" class="control-label">Company Logo</label>
		...
		<div class="form-group col-6 d-flex justify-content-center">
			<img src="<?php echo validate_image(isset($id) ? "uploads/company_logos/{$id}.png?v=".strtotime($date_updated) :'') ?>" alt="" id="cimg" class="img-fluid img-thumbnail bg-lightgradient">
		</div>
	</form>
</div>
<script>
