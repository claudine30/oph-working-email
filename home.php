...
<header id="top-header" class="d-flex justify-content-center align-items-end py-3 px-5">
    ...
    <div class="mb-5 pb-5">
        <h1 class='text-center title' style="color: white" font-family= "Poppins">Welcome to <?php echo $_settings->info('name') ?></h1>
    </div>
    </div>
</header>
<section class="py-4">
...
<section class="py-4 bg-gradient-dark">
    <div class="container">
        <h2 class="text-center">Conveniently pay online through these easy steps!</h2>
